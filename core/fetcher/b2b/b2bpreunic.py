...
from core.sources.b2b.b2bpreunic import PreunicB2BPortalSource, PreunicB2BSalesSource, PreunicB2BStockSource
...
class PreunicB2BSales(B2BFile, PreunicB2BSalesSource, OnlyCsvStorage, DailyFetcher):

    name = 'b2b-preunic-files'

    string_variables = {
        'username': 'B2B_USERNAME_PREUNIC',
...
class PreunicB2BStock(PreunicB2BStockSource, PreunicB2BSales):

    name = 'b2b-preunic-stock'
...
class PreunicB2BPortal(B2BPortalBase, PreunicB2BPortalSource, B2BWebFetcher):

    name = 'b2b-preunic-portal'

    DAYS_TO_CONSOLIDATE = 44

    related_fetchers = [PreunicB2BSales]
